...
const productSeeds = [
  ...
  },
  {
    ...
    benefits: ["ফাইবারসমৃদ্ধ হওয়ায় পেট ভরা রাখতে সহায়ক", "গরমের দিনে শরবত ও পানীয়তে আরামদায়ক সংযোজন", "দৈনন্দিন স্বাস্থ্যকর রুটিনে সহজে ব্যবহারযোগ্য", "ফালুদা, দুধ ও স্মুদিতে সুন্দর টেক্সচার যোগ করে"],
    ingredients: ["১০০% পরিষ্কার তোকমা দানা (Basil Seeds)"],
    usageInstructions: ["১-২ চা চামচ তোকমা দানা ১৫-২০ মিনিট পানিতে ভিজিয়ে নিন। শরবত, দুধ, ফালুদা বা স্মুদির সাথে মিশিয়ে পরিবেশন করুন।"]
  },
  {
    nameBn: "ইসবগুল ভুসি",
    ...
    benefits: ["প্রাকৃতিক ফাইবারের সহজ উৎস", "দৈনন্দিন রুটিনে হালকা ও ব্যবহারবান্ধব", "পানি, দুধ বা জুসের সাথে দ্রুত মিশে যায়", "স্বাস্থ্যকর খাদ্যাভ্যাসে সহায়ক সংযোজন"],
    ingredients: ["১০০% ইসবগুল ভুসি (Psyllium Husk)"],
    usageInstructions: ["১-২ চা চামচ ইসবগুল ভুসি এক গ্লাস পানিতে মিশিয়ে দ্রুত পান করুন। ব্যবহারের পর পর্যাপ্ত পানি পান করা ভালো।"]
  },
  {
    nameBn: "খাঁটি মধু",
    nameEn: "Pure Honey",
